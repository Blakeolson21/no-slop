...
## [1.54.0](https://github.com/Blakeolson21/no-slop/compare/v1.53.0...v1.54.0) (2026-08-17)


### Features

* **agent:** add ACP target support via acpx ([#165](https://github.com/Blakeolson21/no-slop/issues/165)) ([e6db093](https://github.com/Blakeolson21/no-slop/commit/e6db09381ca1d64725427006ea960bc1ea827b15))
* **agent:** add Cursor as a first-class ACP alias ([#422](https://github.com/Blakeolson21/no-slop/issues/422)) ([8abc1ed](https://github.com/Blakeolson21/no-slop/commit/8abc1ed63b5cdef5aca31d4f17c7482aa4275750))
* **agent:** add GitHub Copilot CLI agent backend ([#318](https://github.com/Blakeolson21/no-slop/issues/318)) ([aedb3a1](https://github.com/Blakeolson21/no-slop/commit/aedb3a1406e734a696ee1182af28e804e8314f07))
* **agent:** add Pi agent support ([#161](https://github.com/Blakeolson21/no-slop/issues/161)) ([9048a93](https://github.com/Blakeolson21/no-slop/commit/9048a934651ba784aff44d0727ae5142329bb143))
* **agent:** neutralize Pi project context files ([#586](https://github.com/Blakeolson21/no-slop/issues/586)) ([829ee34](https://github.com/Blakeolson21/no-slop/commit/829ee34703bdc1d7cb216e6c33166803944f6f85))
* **agent:** record session-fidelity telemetry ([#457](https://github.com/Blakeolson21/no-slop/issues/457)) ([8ec98db](https://github.com/Blakeolson21/no-slop/commit/8ec98db2a39a054a90071dfd0c8175785c6343a9))
* **agent:** support agent args override ([#133](https://github.com/Blakeolson21/no-slop/issues/133)) ([18c58ae](https://github.com/Blakeolson21/no-slop/commit/18c58aef526a7c2b887246e80c9455bbebe27811))
* **agent:** support ordered fallback agent lists ([#379](https://github.com/Blakeolson21/no-slop/issues/379)) ([59278f1](https://github.com/Blakeolson21/no-slop/commit/59278f156c670e568ca5b75d507746dd4ab92088))
* **agent:** suppress project settings for gate agents ([#463](https://github.com/Blakeolson21/no-slop/issues/463)) ([2d02c90](https://github.com/Blakeolson21/no-slop/commit/2d02c90cc964c280a6b849380dab26d3224b4549))
* auto-resolve actionable findings in yolo mode ([#246](https://github.com/Blakeolson21/no-slop/issues/246)) ([1c99c4c](https://github.com/Blakeolson21/no-slop/commit/1c99c4ce97d591fc4e7300c699389973b78b1c4b))
* **bitbucket:** add Bitbucket Cloud PR and CI support ([#85](https://github.com/Blakeolson21/no-slop/issues/85)) ([800f0e9](https://github.com/Blakeolson21/no-slop/commit/800f0e9a4db73deb46cf6bca3aa2858c59552ee1))
* **branchsync:** add guarded local branch synchronization ([#496](https://github.com/Blakeolson21/no-slop/issues/496)) ([e9b4c14](https://github.com/Blakeolson21/no-slop/commit/e9b4c14dfd6b444049e1d594b26e40124c4973a3))
* **branchsync:** reconcile equivalent diverged sync heads ([#504](https://github.com/Blakeolson21/no-slop/issues/504)) ([0a2c82f](https://github.com/Blakeolson21/no-slop/commit/0a2c82f993b9467c5ab84992313dfd13b66830af))
* **branchsync:** recover custody for terminal pipeline-owned runs ([#502](https://github.com/Blakeolson21/no-slop/issues/502)) ([0bca236](https://github.com/Blakeolson21/no-slop/commit/0bca23626016105c0c6f56a702b5b7ec3a86f42a))
* **cli:** add AXI agent command surface ([#241](https://github.com/Blakeolson21/no-slop/issues/241)) ([d3a54e0](https://github.com/Blakeolson21/no-slop/commit/d3a54e0050ee279b1aba9315be0fc4698ee020ee))
* **cli:** add daemon restart command ([#102](https://github.com/Blakeolson21/no-slop/issues/102)) ([795a42d](https://github.com/Blakeolson21/no-slop/commit/795a42da12eb72bd1952beda902f77f79a6cc2ea))
* **cli:** add non-interactive setup wizard with --yes ([#105](https://github.com/Blakeolson21/no-slop/issues/105)) ([99d2715](https://github.com/Blakeolson21/no-slop/commit/99d27152f064a78864dc0fe08392d0d41f545d3f))
* **cli:** add per-run pipeline step skipping ([#169](https://github.com/Blakeolson21/no-slop/issues/169)) ([5992808](https://github.com/Blakeolson21/no-slop/commit/59928089f495d7c1731cd784202fa7131098337f))
* **cli:** add usage stats command ([#179](https://github.com/Blakeolson21/no-slop/issues/179)) ([990b26c](https://github.com/Blakeolson21/no-slop/commit/990b26cb8e405d83f03d33e16be7a46fe4d3ea20))
* **cli:** cache wizard commit subject from branch suggestions ([#117](https://github.com/Blakeolson21/no-slop/issues/117)) ([134fadb](https://github.com/Blakeolson21/no-slop/commit/134fadb3273e11835bcb43b6d8c8866a14d3575a))
* **cli:** emit AXI pageview telemetry ([#252](https://github.com/Blakeolson21/no-slop/issues/252)) ([ba97def](https://github.com/Blakeolson21/no-slop/commit/ba97def4daaa4389b864685400759b91bdd96d14))
* **cli:** expose parked awaiting-agent status ([#329](https://github.com/Blakeolson21/no-slop/issues/329)) ([57a62da](https://github.com/Blakeolson21/no-slop/commit/57a62da91d7089f80d92fc6f4373a49f1fe73319))
* **cli:** install agent skill at user level ([#284](https://github.com/Blakeolson21/no-slop/issues/284)) ([f6760aa](https://github.com/Blakeolson21/no-slop/commit/f6760aa115aaa3ea3efdb4402383af429ad5aaba))
* **cli:** keep the setup wizard visible for interactive --yes runs ([#109](https://github.com/Blakeolson21/no-slop/issues/109)) ([dffa857](https://github.com/Blakeolson21/no-slop/commit/dffa857b721db761c0505ca43af785f4d453f137))
* **cli:** report applied fixes in successful AXI output ([#274](https://github.com/Blakeolson21/no-slop/issues/274)) ([8271fef](https://github.com/Blakeolson21/no-slop/commit/8271fef7b9852acbb4f2a8b8cedcfb4a061b3892))
* **cli:** surface AXI step activity and auto-fix diagnostics ([#413](https://github.com/Blakeolson21/no-slop/issues/413)) ([6fcf9d5](https://github.com/Blakeolson21/no-slop/commit/6fcf9d59df29facbcde28c5a4981187e9e2b5a90))
* **config:** add auto agent detection and diagnostics ([#53](https://github.com/Blakeolson21/no-slop/issues/53)) ([4d64ffe](https://github.com/Blakeolson21/no-slop/commit/4d64ffec3a0ec701673c25aa0d343616e8dd9e9e))
* **config:** configure pipeline fix commit messages ([#511](https://github.com/Blakeolson21/no-slop/issues/511)) ([be6921e](https://github.com/Blakeolson21/no-slop/commit/be6921ef4f739b7e068ec3a315617f3df328f6b6))
* **daemon:** add managed daemon service startup with fallback ([#78](https://github.com/Blakeolson21/no-slop/issues/78)) ([c52463f](https://github.com/Blakeolson21/no-slop/commit/c52463fe4e053fb898653e585d2c86bec38f9c5f))
* **db:** record build identity on run records ([#687](https://github.com/Blakeolson21/no-slop/issues/687)) ([5fc7bc7](https://github.com/Blakeolson21/no-slop/commit/5fc7bc7353f020f302f125a2534e874256580fa1))
* **demo:** add scripted demo pipeline workflow ([#83](https://github.com/Blakeolson21/no-slop/issues/83)) ([af25153](https://github.com/Blakeolson21/no-slop/commit/af25153229303fa782c480b8ba016ac8b6d1d6b1))
* Developer ID sign macOS release artifacts ([#455](https://github.com/Blakeolson21/no-slop/issues/455)) ([776088d](https://github.com/Blakeolson21/no-slop/commit/776088d179d06ebce78a932ab49373405fb35c0f))
* **docs:** add custom hero CSS and update docs ([8d5e020](https://github.com/Blakeolson21/no-slop/commit/8d5e0209195b67b366cf192f8330cf8dc21bfec1))
* **eval:** add local review evaluation toolkit ([#701](https://github.com/Blakeolson21/no-slop/issues/701)) ([331ee93](https://github.com/Blakeolson21/no-slop/commit/331ee9386f7a6765f7880313b01ca78a6b16983a))
* **eval:** automatically collect an affordable local corpus ([#711](https://github.com/Blakeolson21/no-slop/issues/711)) ([366dfce](https://github.com/Blakeolson21/no-slop/commit/366dfce2673dbd4bc566c58ea6c6a4edb37c4576))
* **eval:** ingest confirmed post-PR misses as false-negative gold ([#744](https://github.com/Blakeolson21/no-slop/issues/744)) ([f92b7bd](https://github.com/Blakeolson21/no-slop/commit/f92b7bd6da88904d8066ba70181a4491312fe4fe))
* **eval:** label findings by recorded decision and match gold globally ([#753](https://github.com/Blakeolson21/no-slop/issues/753)) ([f808d23](https://github.com/Blakeolson21/no-slop/commit/f808d2389ff76d002d821a6f43999189f95fc102))
* **eval:** pin gold-only holdout and merge-derived finding gold ([#739](https://github.com/Blakeolson21/no-slop/issues/739)) ([dac4dc9](https://github.com/Blakeolson21/no-slop/commit/dac4dc9bb34aea7a6074b5ff508046fa34de1085))
* **eval:** score replay findings against human gold ([#726](https://github.com/Blakeolson21/no-slop/issues/726)) ([a3954e1](https://github.com/Blakeolson21/no-slop/commit/a3954e19f232b944bacfb2599faee946045d6671))
* **evidence:** publish artifacts to an orphan branch ([#679](https://github.com/Blakeolson21/no-slop/issues/679)) ([d37d9cc](https://github.com/Blakeolson21/no-slop/commit/d37d9cc440d382542cc225c8dc2f290643d6e5e6))
* **git:** support GitHub fork routing ([#306](https://github.com/Blakeolson21/no-slop/issues/306)) ([7974313](https://github.com/Blakeolson21/no-slop/commit/79743139e5930ea1f61cee5e2733b0341a2081eb))
* **intent:** add transcript-based intent extraction ([#173](https://github.com/Blakeolson21/no-slop/issues/173)) ([5f0301d](https://github.com/Blakeolson21/no-slop/commit/5f0301d75b061978c16dd6938f5646339c9e57ef))
* **intent:** disambiguate ambiguous session matches ([#204](https://github.com/Blakeolson21/no-slop/issues/204)) ([f784c80](https://github.com/Blakeolson21/no-slop/commit/f784c8052239b8f9c9e3fe08abe349c223cc6ab8))
* **intent:** support Pi transcript reading ([#210](https://github.com/Blakeolson21/no-slop/issues/210)) ([f21f1f6](https://github.com/Blakeolson21/no-slop/commit/f21f1f6984070017030649094d6b57053ea8a177))
* **noslop:** add redundant-comment lens and rename-aware change loading ([d693a10](https://github.com/Blakeolson21/no-slop/commit/d693a1006f2f4b63695b1f31ee92868e556292f6))
* **noslop:** add risk-proportional slop engine ([f8f39a8](https://github.com/Blakeolson21/no-slop/commit/f8f39a81dfe4fd968843985401b27f4ec9bf0e38))
* **noslop:** condition review policy on provenance ([d02b1e0](https://github.com/Blakeolson21/no-slop/commit/d02b1e08152545c5868963fd1b7dab43892a1b7c))
* **noslop:** detect redundant comments ([d4724c2](https://github.com/Blakeolson21/no-slop/commit/d4724c28b6d921205e2aa0a4646644c1629fafd5))
* **noslop:** publish measured corpus evaluation ([5e6b3dc](https://github.com/Blakeolson21/no-slop/commit/5e6b3dc7d2671a3c6f68df209c02a92ab88d6a1e))
* **pipeline:** add intent extraction as a pipeline step ([#175](https://github.com/Blakeolson21/no-slop/issues/175)) ([78c9e7d](https://github.com/Blakeolson21/no-slop/commit/78c9e7d7d4d5d5e836f3508e193dc9c86ac04e2e))
* **pipeline:** add PR intent sections ([#177](https://github.com/Blakeolson21/no-slop/issues/177)) ([d7eb261](https://github.com/Blakeolson21/no-slop/commit/d7eb261b27b04425e70fd41e155ef817d7240152))
* **pipeline:** add structured step attestations to PR bodies ([#670](https://github.com/Blakeolson21/no-slop/issues/670)) ([aead596](https://github.com/Blakeolson21/no-slop/commit/aead596d693ff116b9b1f1d72f810826911967e8))
* **pipeline:** add testing details to PR summaries ([#104](https://github.com/Blakeolson21/no-slop/issues/104)) ([7adb743](https://github.com/Blakeolson21/no-slop/commit/7adb743b14033508a4f6f7aa42631d9a0ae6e914))
* **pipeline:** assess durable bug fixes ([#550](https://github.com/Blakeolson21/no-slop/issues/550)) ([92752c1](https://github.com/Blakeolson21/no-slop/commit/92752c120c0cd071ce4ef04cf37caab7190e1049))
* **pipeline:** enforce behavior-based test guidance ([#607](https://github.com/Blakeolson21/no-slop/issues/607)) ([df10389](https://github.com/Blakeolson21/no-slop/commit/df1038941a4121fb5bfc3d2b3e99f2d8eab13586))
* **pipeline:** persist uncertified fixer commits for the next initial review ([#745](https://github.com/Blakeolson21/no-slop/issues/745)) ([a68298e](https://github.com/Blakeolson21/no-slop/commit/a68298ea66c248d04d0fffec76db3f1d7d18a402))
* **pipeline:** prefer root-cause fix prompts ([#182](https://github.com/Blakeolson21/no-slop/issues/182)) ([865e9ba](https://github.com/Blakeolson21/no-slop/commit/865e9ba748219f90be0583be643f04984b622a9c))
* **pipeline:** re-run provider-cancelled CI checks before escalating ([#595](https://github.com/Blakeolson21/no-slop/issues/595)) ([1753783](https://github.com/Blakeolson21/no-slop/commit/17537830a92de42e0b8c3848bfab8e2301be8923))
* **pipeline:** reuse review sessions and streamline telemetry ([#444](https://github.com/Blakeolson21/no-slop/issues/444)) ([48bd29f](https://github.com/Blakeolson21/no-slop/commit/48bd29f6c04eef9876d4e85bf97af465de023df4))
* **pipeline:** scope review guidance to the paths a change touches ([#594](https://github.com/Blakeolson21/no-slop/issues/594)) ([5f89e1f](https://github.com/Blakeolson21/no-slop/commit/5f89e1f9233c20b28ac59bc689fa5a3df58cf027))
* **pipeline:** skip remaining steps on empty diff ([#50](https://github.com/Blakeolson21/no-slop/issues/50)) ([4d74bc2](https://github.com/Blakeolson21/no-slop/commit/4d74bc22ff8cf85f18806b10c4943c74d7cf511c))
* **pipeline:** store test evidence in repos ([#235](https://github.com/Blakeolson21/no-slop/issues/235)) ([ec6d7dc](https://github.com/Blakeolson21/no-slop/commit/ec6d7dc34d7ae09279d483f185c9d47bbf10c66a))
* **pipeline:** surface intent-based test evidence ([#196](https://github.com/Blakeolson21/no-slop/issues/196)) ([7d2880d](https://github.com/Blakeolson21/no-slop/commit/7d2880deb49d6e47cb691d68f068e102801a711b))
* **pipeline:** track round history across fix cycles ([#94](https://github.com/Blakeolson21/no-slop/issues/94)) ([9596176](https://github.com/Blakeolson21/no-slop/commit/9596176c4943665e9ecf4abf3b605b3c198c1634))
* **pipeline:** ungate review counterexample tracing and name silent-wrong-result risks ([#743](https://github.com/Blakeolson21/no-slop/issues/743)) ([7cd86d4](https://github.com/Blakeolson21/no-slop/commit/7cd86d4209ac79f4a0923b62c298524183f5d672))
* **prsummary:** improve generated PR description output ([#57](https://github.com/Blakeolson21/no-slop/issues/57)) ([bb4f0bc](https://github.com/Blakeolson21/no-slop/commit/bb4f0bc3e285163e428d3bacf94aa7ac4a7be1f2))
* rename product identity to no-slop ([#2](https://github.com/Blakeolson21/no-slop/issues/2)) ([a9b9be5](https://github.com/Blakeolson21/no-slop/commit/a9b9be556a7b1f3386be089e91d0d0672a74fa97))
* **review:** add convergence telemetry and ladder guard for the review-fix loop ([7390a65](https://github.com/Blakeolson21/no-slop/commit/7390a651fd59dc57e49b5a2789adab62a6b8c5e4))
* **scm:** add Azure DevOps provider ([#369](https://github.com/Blakeolson21/no-slop/issues/369)) ([78c7e60](https://github.com/Blakeolson21/no-slop/commit/78c7e606ce598491d50e72bf532045f4684ca8b7))
* **scm:** add GitHub Enterprise Server provider detection and host-prefixed slug ([#377](https://github.com/Blakeolson21/no-slop/issues/377)) ([d4f9274](https://github.com/Blakeolson21/no-slop/commit/d4f927462ad942ed9fd50bf065f14bd66e0c5e92))
* **scm:** detect self-hosted GitLab out of the box with glab v1.5x ([#346](https://github.com/Blakeolson21/no-slop/issues/346)) ([42ae9c2](https://github.com/Blakeolson21/no-slop/commit/42ae9c280e78299b7e161e2e83dfbe10bc1478a2))
* **skill:** support task-first no-mistakes invocation ([#259](https://github.com/Blakeolson21/no-slop/issues/259)) ([831c2c1](https://github.com/Blakeolson21/no-slop/commit/831c2c159e9578b0425183fc472134b3fe4770b8))
* **telemetry:** add CLI and pipeline telemetry tracking ([#98](https://github.com/Blakeolson21/no-slop/issues/98)) ([234a900](https://github.com/Blakeolson21/no-slop/commit/234a9005da13b7eede50ead93393776f55eb977f))
* **telemetry:** track wizard and tui pageviews ([#100](https://github.com/Blakeolson21/no-slop/issues/100)) ([6056357](https://github.com/Blakeolson21/no-slop/commit/605635782508f6ce5764c09d6c0d6f3eb215f936))
* **tui:** add finding overrides for manual fix rounds ([#135](https://github.com/Blakeolson21/no-slop/issues/135)) ([4b62714](https://github.com/Blakeolson21/no-slop/commit/4b62714cb55be3a09fe1acd1da1532dea39d2583))
* **tui:** add rerun action for completed pipeline runs ([#71](https://github.com/Blakeolson21/no-slop/issues/71)) ([0759e07](https://github.com/Blakeolson21/no-slop/commit/0759e077a03b71de8f79a87fe85858ce949ac0f9))
* **tui:** add yolo auto-approval mode ([#227](https://github.com/Blakeolson21/no-slop/issues/227)) ([570c9f9](https://github.com/Blakeolson21/no-slop/commit/570c9f9d8694c04c5a19219f5ac5f14f9301be34))
* **tui:** show cached update indicator in footer ([#72](https://github.com/Blakeolson21/no-slop/issues/72)) ([09f0e0d](https://github.com/Blakeolson21/no-slop/commit/09f0e0d8b2d0e1e82fe07b759f670b9e5f1f0d10))
* **tui:** show checks-passed CI monitoring state ([#245](https://github.com/Blakeolson21/no-slop/issues/245)) ([4d741be](https://github.com/Blakeolson21/no-slop/commit/4d741bedf07a9ea6171089150d699e7e83174e8b))
* **tui:** show fixed finding progress in pipeline rows ([#189](https://github.com/Blakeolson21/no-slop/issues/189)) ([45f6aba](https://github.com/Blakeolson21/no-slop/commit/45f6aba6762df563bac631fc26e352a7caa1f00d))
* **update:** add beta release channel ([#136](https://github.com/Blakeolson21/no-slop/issues/136)) ([907e6e3](https://github.com/Blakeolson21/no-slop/commit/907e6e33f44d843915e946b4b26689f6c91fa158))
* **wizard:** add branch-aware setup flow for run startup ([#96](https://github.com/Blakeolson21/no-slop/issues/96)) ([da3daf4](https://github.com/Blakeolson21/no-slop/commit/da3daf4a0dd964417986e507ee3fe6dd6d54b6fd))
* **wizard:** show setup progress in terminal title ([#116](https://github.com/Blakeolson21/no-slop/issues/116)) ([4d42a7a](https://github.com/Blakeolson21/no-slop/commit/4d42a7adabd63c888c1e970829be766897306530))


### Bug Fixes

* **agent:** disable interactive git prompts ([#231](https://github.com/Blakeolson21/no-slop/issues/231)) ([348390d](https://github.com/Blakeolson21/no-slop/commit/348390d4316b51799ecdd618a7326265e417cee0))
* **agent:** extend managed server health timeout ([#218](https://github.com/Blakeolson21/no-slop/issues/218)) ([403b142](https://github.com/Blakeolson21/no-slop/commit/403b142362d4dbeb71dbac2c788febb1f4cb7233))
* **agent:** harden rovodev SSE parsing and server health checks ([#93](https://github.com/Blakeolson21/no-slop/issues/93)) ([e7e377f](https://github.com/Blakeolson21/no-slop/commit/e7e377ff347c63c801b4143e6d28af3955f68bf9))
* **agent:** harden structured JSON fallback parsing ([#144](https://github.com/Blakeolson21/no-slop/issues/144)) ([21449db](https://github.com/Blakeolson21/no-slop/commit/21449dbdcffabe35bc6c34b4c39fdb6ba2a5fae4))
* **agent:** kill child process group on cancel (no orphan subprocesses) ([#300](https://github.com/Blakeolson21/no-slop/issues/300)) ([19045f6](https://github.com/Blakeolson21/no-slop/commit/19045f6e04251f9b746467dcc6ad372cb4658f42))
* **agent:** reap agent process group on clean exit to prevent daemon OOM crash ([#357](https://github.com/Blakeolson21/no-slop/issues/357)) ([bdd2e39](https://github.com/Blakeolson21/no-slop/commit/bdd2e3932e6b49830c622ed00cf7b99635688fca))
* **agent:** retry transient invocation failures ([#159](https://github.com/Blakeolson21/no-slop/issues/159)) ([ebdaac7](https://github.com/Blakeolson21/no-slop/commit/ebdaac7afaddf88f77deaf0d21dce3e3c35248ea))
* **agent:** skip quota-exhausted agent lanes mid-run ([9e390a6](https://github.com/Blakeolson21/no-slop/commit/9e390a65181c24a84c03b8df787fdf77455e1534))
* **agent:** steer pipeline agents away from system writes ([#229](https://github.com/Blakeolson21/no-slop/issues/229)) ([9f88c13](https://github.com/Blakeolson21/no-slop/commit/9f88c1339af4cd7647d3de0eb5ce30fd7a656f71))
* **agent:** support Codex output schema parsing ([#141](https://github.com/Blakeolson21/no-slop/issues/141)) ([f4f253e](https://github.com/Blakeolson21/no-slop/commit/f4f253efdc3eeba34ad852d97f791ee7a034b060))
* **agent:** surface opencode StructuredOutputError instead of text-parsing prose ([#375](https://github.com/Blakeolson21/no-slop/issues/375)) ([02009a8](https://github.com/Blakeolson21/no-slop/commit/02009a8535761eb41f8dea07118e71f86c9f0644))
* **branchsync:** prefer newer pushed descendants over stale custody ([#622](https://github.com/Blakeolson21/no-slop/issues/622)) ([2d0fa98](https://github.com/Blakeolson21/no-slop/commit/2d0fa98f9207451f739b046211ec1a32db4cb76d))
* **branchsync:** recover custody from contained rebased heads ([#649](https://github.com/Blakeolson21/no-slop/issues/649)) ([73425eb](https://github.com/Blakeolson21/no-slop/commit/73425eb4ecc88607a12b444c4dbd245d221cac92))
* **branchsync:** return custody when the gate never moved past submission ([0bd6279](https://github.com/Blakeolson21/no-slop/commit/0bd62793fc7b5a4eacbb3970d803aac25924adfc))
* **ci:** handle merge conflicts in babysit and harden mergeability checks ([#69](https://github.com/Blakeolson21/no-slop/issues/69)) ([9e86144](https://github.com/Blakeolson21/no-slop/commit/9e861448314cc4ccddd259e5acd1f1bd03ec73ba))
* **ci:** improve auto-fix no-change handling and reporting ([#55](https://github.com/Blakeolson21/no-slop/issues/55)) ([174dbeb](https://github.com/Blakeolson21/no-slop/commit/174dbebbbfe934cf84c9ce03125a812574489222))
* **cimonitor:** require trusted no-CI evidence for readiness ([#628](https://github.com/Blakeolson21/no-slop/issues/628)) ([90885ee](https://github.com/Blakeolson21/no-slop/commit/90885ee7c8f60b5558a5896414d3f50e759ca5da))
* **cli:** clarify AXI gate guidance ([#344](https://github.com/Blakeolson21/no-slop/issues/344)) ([8ebc9eb](https://github.com/Blakeolson21/no-slop/commit/8ebc9ebfa2f592da09d5c54f89b634e8a1ec8bf8))
* **cli:** clarify pipeline-owned finding fixes ([#272](https://github.com/Blakeolson21/no-slop/issues/272)) ([e6d46fd](https://github.com/Blakeolson21/no-slop/commit/e6d46fd6cb120afe1da946822be8186f9d13d51b))
* **cli:** clarify stale CI monitor guidance ([#352](https://github.com/Blakeolson21/no-slop/issues/352)) ([87b2abf](https://github.com/Blakeolson21/no-slop/commit/87b2abf78888d8af738903415f5f4b58e61e2396))
* **cli:** confirm abort truth before releasing branch custody ([#631](https://github.com/Blakeolson21/no-slop/issues/631)) ([a93dc8f](https://github.com/Blakeolson21/no-slop/commit/a93dc8ff6a942d8d69fce97c3afc1bb11bf3fdc6))
* **cli:** guard destructive daemon lifecycle commands against active runs ([#415](https://github.com/Blakeolson21/no-slop/issues/415)) ([493fc69](https://github.com/Blakeolson21/no-slop/commit/493fc69d62b3d6b841080233230ce90c5fcf7b6e))
* **cli:** keep AXI output readable with control bytes ([#523](https://github.com/Blakeolson21/no-slop/issues/523)) ([37864fe](https://github.com/Blakeolson21/no-slop/commit/37864fe1053d9065b64522b515745793e7412f95))
* **cli:** keep AXI runs branch-aware ([#288](https://github.com/Blakeolson21/no-slop/issues/288)) ([94afd17](https://github.com/Blakeolson21/no-slop/commit/94afd170f44855aa55a782a9e3cbf6a64195ab35))
* **cli:** reattach active AXI runs by submitted head ([#514](https://github.com/Blakeolson21/no-slop/issues/514)) ([26200ed](https://github.com/Blakeolson21/no-slop/commit/26200ed06a7ae460396937e49410974f2d2ac81f))
* **cli:** stop axi drive after CI checks pass ([#247](https://github.com/Blakeolson21/no-slop/issues/247)) ([badf49f](https://github.com/Blakeolson21/no-slop/commit/badf49f690f896e41a2d71fe59218f049260167f))
* **config:** disable auto-fix review by default ([#63](https://github.com/Blakeolson21/no-slop/issues/63)) ([c7a55df](https://github.com/Blakeolson21/no-slop/commit/c7a55dfcb2ce6f334596f59721176d88d7eddd0f))
* **config:** fail gate validation when no pipeline agent is runnable ([#437](https://github.com/Blakeolson21/no-slop/issues/437)) ([3752c1a](https://github.com/Blakeolson21/no-slop/commit/3752c1a0fb7b76ff40f83143eea799fbd6e7d5b0))
* **conventional:** infer release types for non-conventional titles ([#185](https://github.com/Blakeolson21/no-slop/issues/185)) ([1b84147](https://github.com/Blakeolson21/no-slop/commit/1b8414745658952d42cfc3af3a1b9a6f4f86960f))
* **daemon:** bound IPC connect attempts with a configurable timeout ([#403](https://github.com/Blakeolson21/no-slop/issues/403)) ([c663aee](https://github.com/Blakeolson21/no-slop/commit/c663aeee95d34b07351c3a0fbd105acbfcf5ac3a))
* **daemon:** bound startup recovery and harden gate migration ([#562](https://github.com/Blakeolson21/no-slop/issues/562)) ([680a268](https://github.com/Blakeolson21/no-slop/commit/680a268947dd0d9fa58d279f1941e9ce56d41880))
* **daemon:** clean stale artifacts when stopping an already-dead daemon ([1a56395](https://github.com/Blakeolson21/no-slop/commit/1a56395cc889fc915ffe54db24052ca1c2badf6a))
* **daemon:** clean up timed-out daemon startups safely ([#128](https://github.com/Blakeolson21/no-slop/issues/128)) ([b6a2389](https://github.com/Blakeolson21/no-slop/commit/b6a238921439347e377ed6ed46f4716e95830b6b))
* **daemon:** detect stray daemons by resolved root before start ([#360](https://github.com/Blakeolson21/no-slop/issues/360)) ([6c59484](https://github.com/Blakeolson21/no-slop/commit/6c594845054c896a316bfc124489725624323d8b))
* **daemon:** enforce single-daemon ownership per NM_HOME ([#411](https://github.com/Blakeolson21/no-slop/issues/411)) ([bbdf1f0](https://github.com/Blakeolson21/no-slop/commit/bbdf1f0be8edd5c2917cb6bcc8cc6441d1e6a78f))
* **daemon:** ensure service manager is bypassed during go test ([#82](https://github.com/Blakeolson21/no-slop/issues/82)) ([fef7527](https://github.com/Blakeolson21/no-slop/commit/fef752776b93c8cc59f584eac22edf4a001396ce))
* **daemon:** forward proxy env vars into managed daemon service definitions ([#322](https://github.com/Blakeolson21/no-slop/issues/322)) ([03f5157](https://github.com/Blakeolson21/no-slop/commit/03f515777c16db8fab0a58ee9000da86d409e6f4))
* **daemon:** harden orphaned agent server recovery ([#121](https://github.com/Blakeolson21/no-slop/issues/121)) ([7600bb7](https://github.com/Blakeolson21/no-slop/commit/7600bb7de56772dd67c6e023c5deec2608d0572b))
* **daemon:** move test evidence out of system temp storage ([#735](https://github.com/Blakeolson21/no-slop/issues/735)) ([2498e75](https://github.com/Blakeolson21/no-slop/commit/2498e75f6a075efc710b2cda18333a3a69986c7c))
* **daemon:** preserve intent provenance across reruns ([#624](https://github.com/Blakeolson21/no-slop/issues/624)) ([7e336cb](https://github.com/Blakeolson21/no-slop/commit/7e336cb8d748d796562ac73786e4708582622872))
* **daemon:** preserve run state under event stream pressure ([#626](https://github.com/Blakeolson21/no-slop/issues/626)) ([58b52ee](https://github.com/Blakeolson21/no-slop/commit/58b52eeec186466891e902590ee91f56c9b76508))
* **daemon:** reap lingering run-worktree processes that escape their process group ([#685](https://github.com/Blakeolson21/no-slop/issues/685)) ([a385367](https://github.com/Blakeolson21/no-slop/commit/a3853679302f2a953640de3ca07e70ebc7c0b77b))
* **daemon:** refresh managed hooks during recovery ([#171](https://github.com/Blakeolson21/no-slop/issues/171)) ([13a91c2](https://github.com/Blakeolson21/no-slop/commit/13a91c275d7549d82fc4ede2d4cc4a0d3336e67b))
* **daemon:** refresh managed services with stable PATH ([#148](https://github.com/Blakeolson21/no-slop/issues/148)) ([cac217f](https://github.com/Blakeolson21/no-slop/commit/cac217f6a931bd0afcde6379cc310bf995285464))
* **daemon:** require explicit daemon run argv, fail fast on dead socket ([#416](https://github.com/Blakeolson21/no-slop/issues/416)) ([b876724](https://github.com/Blakeolson21/no-slop/commit/b87672422163865f0e2dfcc3f1432887ccea2124))
* **daemon:** retry busy launchctl bootstrap ([#150](https://github.com/Blakeolson21/no-slop/issues/150)) ([40412a8](https://github.com/Blakeolson21/no-slop/commit/40412a871bcff44802430b9d8406f1b67d945f1f))
* **daemon:** scope managed service names by NM_HOME ([#84](https://github.com/Blakeolson21/no-slop/issues/84)) ([65375dc](https://github.com/Blakeolson21/no-slop/commit/65375dc3ff98f7ed61f17358df5cb19d1c555e37))
* **daemon:** tighten detached fallback around managed service stop failures ([#115](https://github.com/Blakeolson21/no-slop/issues/115)) ([957065a](https://github.com/Blakeolson21/no-slop/commit/957065a3637cc0b971eadb8d651ecb95feebc76e))
* **daemon:** update panic error status after telemetry ([#106](https://github.com/Blakeolson21/no-slop/issues/106)) ([c188e12](https://github.com/Blakeolson21/no-slop/commit/c188e12cf47f144de9ad02a083cccceec315a063))
* **daemon:** wait for process exit before restart ([#609](https://github.com/Blakeolson21/no-slop/issues/609)) ([a7f32ee](https://github.com/Blakeolson21/no-slop/commit/a7f32ee0f74a6bf329b7a54ab2f6764272f5a9ea))
* **db:** finalize runs on terminal PR outcomes ([#570](https://github.com/Blakeolson21/no-slop/issues/570)) ([62ab989](https://github.com/Blakeolson21/no-slop/commit/62ab9899d7cd0ef0c0f1e171bc65ad916bcfa613))
* **document,review:** correct spelling errors (unparseable -&gt; unparsable, funcitonal -&gt; functional) ([#262](https://github.com/Blakeolson21/no-slop/issues/262)) ([de69d5e](https://github.com/Blakeolson21/no-slop/commit/de69d5e9881865c5da878044b58804ae10c2db83))
* **e2e:** reclaim temporary daemons after interrupted runs ([#543](https://github.com/Blakeolson21/no-slop/issues/543)) ([3d4691a](https://github.com/Blakeolson21/no-slop/commit/3d4691aedba97d9f877c073e3e652a8fde69d574))
* execute every PR body compliance event ([#558](https://github.com/Blakeolson21/no-slop/issues/558)) ([912bc75](https://github.com/Blakeolson21/no-slop/commit/912bc756a44c1b78fa29c5c9c2c722cf92f3aef8))
* **gate:** make init idempotent ([#243](https://github.com/Blakeolson21/no-slop/issues/243)) ([0e1a08b](https://github.com/Blakeolson21/no-slop/commit/0e1a08be7077117864faa854f9cdf08a1590c3e6))
* **gate:** make missing origin errors actionable ([#534](https://github.com/Blakeolson21/no-slop/issues/534)) ([003b123](https://github.com/Blakeolson21/no-slop/commit/003b123096fc18a48b9ee940102e01a1860ab850))
* **gate:** reattach init after repo directory rename ([#270](https://github.com/Blakeolson21/no-slop/issues/270)) ([a2f4fc2](https://github.com/Blakeolson21/no-slop/commit/a2f4fc2afaa6fdff03d0854024703da10b14b498))
* **gate:** redact embedded credentials from stored upstream URLs and error surfaces ([#469](https://github.com/Blakeolson21/no-slop/issues/469)) ([9111e12](https://github.com/Blakeolson21/no-slop/commit/9111e12dc77240331e3178a983583af045e9d056))
* **gate:** refresh repository URLs at run start ([#582](https://github.com/Blakeolson21/no-slop/issues/582)) ([e279099](https://github.com/Blakeolson21/no-slop/commit/e279099c51a667f3d82b3025db88f6ba4736be15))
* **gate:** resolve absolute bare repo dir in post-receive hook ([#269](https://github.com/Blakeolson21/no-slop/issues/269)) ([#358](https://github.com/Blakeolson21/no-slop/issues/358)) ([087fd27](https://github.com/Blakeolson21/no-slop/commit/087fd279bb227e2d9f6112afb4c2d2a100f4fa8a))
* **git:** absolutize PWD in NonInteractiveEnv ([#381](https://github.com/Blakeolson21/no-slop/issues/381)) ([a84593c](https://github.com/Blakeolson21/no-slop/commit/a84593cd4fa622d9aef38788db9c20acb7da431c))
* **git:** bound every git subprocess so a wedged fork cannot spin forever ([2b9db4b](https://github.com/Blakeolson21/no-slop/commit/2b9db4b26afab92099bdfa1599e1757eca9c4f15))
* **git:** isolate gate hooks from shared hookspath changes ([#127](https://github.com/Blakeolson21/no-slop/issues/127)) ([a1d5bab](https://github.com/Blakeolson21/no-slop/commit/a1d5bab0631ae443d9a83943527613b743e95e3b))
* **git:** move core.bare into worktree config ([#130](https://github.com/Blakeolson21/no-slop/issues/130)) ([75f20a9](https://github.com/Blakeolson21/no-slop/commit/75f20a9027732ad121244a174f44f1a312b9f9d7))
* **git:** name bare gate repos explicitly with --git-dir ([#384](https://github.com/Blakeolson21/no-slop/issues/384)) ([7bd8384](https://github.com/Blakeolson21/no-slop/commit/7bd83841c930d4de4d902a1f3af7bea6d7386e6c))
* **git:** resolve gate hook paths robustly ([#383](https://github.com/Blakeolson21/no-slop/issues/383)) ([df2db1e](https://github.com/Blakeolson21/no-slop/commit/df2db1efd4d4d508679064481650195fb4b0b032))
* **git:** resolve main repo root inside submodules ([#454](https://github.com/Blakeolson21/no-slop/issues/454)) ([fc22899](https://github.com/Blakeolson21/no-slop/commit/fc228993bd7c6ef873de01e07a57c69743dbdc5a))
* **git:** widen the exec WaitDelay so load cannot fail a succeeding command ([fc09873](https://github.com/Blakeolson21/no-slop/commit/fc098733f37c4dc912b64e0fb7274e69da80c24a))
* **git:** write worktree identity per-worktree to avoid shared config.lock ([#385](https://github.com/Blakeolson21/no-slop/issues/385)) ([95b4482](https://github.com/Blakeolson21/no-slop/commit/95b4482d2aaae1235b105ba948a839a8b74a291b))
* handle oversized Claude repair prompts ([#526](https://github.com/Blakeolson21/no-slop/issues/526)) ([857885f](https://github.com/Blakeolson21/no-slop/commit/857885f7bcbbaf862eed3fe67acae5abef52ec7c))
* **intent:** improve transcript session matching ([#201](https://github.com/Blakeolson21/no-slop/issues/201)) ([fac4966](https://github.com/Blakeolson21/no-slop/commit/fac496655b8a374add73583e47a9b8d7133c0034))
* **intent:** log accepted candidates only ([#209](https://github.com/Blakeolson21/no-slop/issues/209)) ([c04a2a7](https://github.com/Blakeolson21/no-slop/commit/c04a2a7ee806b192a99c1c8073358ff9938527ee))
* **intent:** read camelCase tool file paths ([#187](https://github.com/Blakeolson21/no-slop/issues/187)) ([3ddbb1e](https://github.com/Blakeolson21/no-slop/commit/3ddbb1e3b136f6924a604eaa4802362b34600a92))
* **ipc:** add daemon request logging without health noise ([#58](https://github.com/Blakeolson21/no-slop/issues/58)) ([a5d8c22](https://github.com/Blakeolson21/no-slop/commit/a5d8c229bb0e6a1ffd483b234e95594c72d3e8af))
* keep CI monitors active and abortable by run id ([#316](https://github.com/Blakeolson21/no-slop/issues/316)) ([0e07573](https://github.com/Blakeolson21/no-slop/commit/0e075737b0d55c3e8479b07991a7fd221c1264d1))
* kunchenguid/no-mistakes[#164](https://github.com/Blakeolson21/no-slop/issues/164) ([#167](https://github.com/Blakeolson21/no-slop/issues/167)) ([7c1e01c](https://github.com/Blakeolson21/no-slop/commit/7c1e01c52b155b45a69d44ef7f05d23173f0bf26))
* **lifecycle:** stop --force killing runs that are executing a step ([0dbf54d](https://github.com/Blakeolson21/no-slop/commit/0dbf54d68f64ab2b0b34ab1506826d7631d8f3e1))
* **noslop:** add deterministic lens prechecks ([b7ebcd7](https://github.com/Blakeolson21/no-slop/commit/b7ebcd79468040ee50ffce3008b25cfff9578e81))
* **noslop:** close adversarial review gaps ([1936ca3](https://github.com/Blakeolson21/no-slop/commit/1936ca308f50ff16d030e8c4da5ecd178b2e22e0))
* **noslop:** close round three review findings ([fcf6dd4](https://github.com/Blakeolson21/no-slop/commit/fcf6dd43417801362c24897af2bab0c022f1f020))
* **noslop:** complete adversarial review protocol ([bd7c8e8](https://github.com/Blakeolson21/no-slop/commit/bd7c8e884a8aa97572e4a0d5fe1d89c1e6f68380))
* **paths:** guard default daemon root under go test ([#451](https://github.com/Blakeolson21/no-slop/issues/451)) ([ba61aaa](https://github.com/Blakeolson21/no-slop/commit/ba61aaa5a6451ca2b0191a063777c93c3e208bd1))
* **pipeline:** add discrete log handling and tests ([#60](https://github.com/Blakeolson21/no-slop/issues/60)) ([75cc374](https://github.com/Blakeolson21/no-slop/commit/75cc374b9a4a1bed46fbfcee8ace027d716b543b))
* **pipeline:** adopt agent self-commits and stop --yes approving unresolved findings ([fa76dcf](https://github.com/Blakeolson21/no-slop/commit/fa76dcfd9d2ecd9f884a69055cba82b384f92e4b))
* **pipeline:** adopt the rebased head on the gate branch ref ([e3cf11c](https://github.com/Blakeolson21/no-slop/commit/e3cf11ca68dd1589167631c8a9069b8d3ec3ef17))
* **pipeline:** bind pushes to the reviewed commit ([#573](https://github.com/Blakeolson21/no-slop/issues/573)) ([574e3aa](https://github.com/Blakeolson21/no-slop/commit/574e3aa651b2ce9bd0bb51cc72eaaa223cb6d3ce))
* **pipeline:** cap generated PR bodies safely ([#370](https://github.com/Blakeolson21/no-slop/issues/370)) ([9059685](https://github.com/Blakeolson21/no-slop/commit/9059685ad88e30554e5228fbb45ffd70f61caf00))
* **pipeline:** commit no-config lint agent fixes ([#192](https://github.com/Blakeolson21/no-slop/issues/192)) ([c900d8d](https://github.com/Blakeolson21/no-slop/commit/c900d8d9a80e63c6182a36b5860b42d91f7da9e9))
* **pipeline:** compact PR testing evidence ([#198](https://github.com/Blakeolson21/no-slop/issues/198)) ([edc7dc3](https://github.com/Blakeolson21/no-slop/commit/edc7dc315dcac735a7d269c7b4eaf96edbf6c8b9))
* **pipeline:** defer run-owned delivery findings ([#494](https://github.com/Blakeolson21/no-slop/issues/494)) ([fc0845a](https://github.com/Blakeolson21/no-slop/commit/fc0845a231628857a628b0f8818cc2a199c48eab))
* **pipeline:** don't gate the test step on informational new-test-file findings ([#417](https://github.com/Blakeolson21/no-slop/issues/417)) ([987bb66](https://github.com/Blakeolson21/no-slop/commit/987bb668ff4b93076270cca9bbd7cdd107940c2e)), closes [#140](https://github.com/Blakeolson21/no-slop/issues/140)
* **pipeline:** embed text evidence in PR summaries ([#222](https://github.com/Blakeolson21/no-slop/issues/222)) ([4eb3dd9](https://github.com/Blakeolson21/no-slop/commit/4eb3dd9b1cc3bf0704c7981fc665852f0bba6f2a))
* **pipeline:** enforce explicit intent during review ([#448](https://github.com/Blakeolson21/no-slop/issues/448)) ([5b0cb40](https://github.com/Blakeolson21/no-slop/commit/5b0cb40cccd7ee95a03c7199965dfd5c419bed08))
* **pipeline:** enforce post-review HEAD continuity ([#574](https://github.com/Blakeolson21/no-slop/issues/574)) ([88dc204](https://github.com/Blakeolson21/no-slop/commit/88dc204f933bbccee5fd144f2fa1e74cb52704c2))
* **pipeline:** extend intent extraction timeout ([#206](https://github.com/Blakeolson21/no-slop/issues/206)) ([90a1829](https://github.com/Blakeolson21/no-slop/commit/90a1829a68a61adef7bf18af87e283140181e0cb))
* **pipeline:** fail the run when the document step reverses a review decision ([1766ef2](https://github.com/Blakeolson21/no-slop/commit/1766ef245465bf8b4b994b3c6bf5be255029d534))
* **pipeline:** focus review fixer verification ([#453](https://github.com/Blakeolson21/no-slop/issues/453)) ([bb0b6bd](https://github.com/Blakeolson21/no-slop/commit/bb0b6bd6d1c6af9f74ca5c10c03866f85837fbc2))
* **pipeline:** generate MP4 demos and gate review fixes ([#91](https://github.com/Blakeolson21/no-slop/issues/91)) ([87b6801](https://github.com/Blakeolson21/no-slop/commit/87b68013ba7ad050574804249be7d6602e399ddb))
* **pipeline:** guard rebase and force-push safety ([#341](https://github.com/Blakeolson21/no-slop/issues/341)) ([5efd0b2](https://github.com/Blakeolson21/no-slop/commit/5efd0b2005dcf6cea17edaf4fe10d0e65b51fc0c))
* **pipeline:** handle orphaned intent base SHAs ([#178](https://github.com/Blakeolson21/no-slop/issues/178)) ([e710e3c](https://github.com/Blakeolson21/no-slop/commit/e710e3c2e582397c418ae905a44ff30809ca57a2))
* **pipeline:** harden CI autofix rerun retry guards ([#123](https://github.com/Blakeolson21/no-slop/issues/123)) ([ac8cb83](https://github.com/Blakeolson21/no-slop/commit/ac8cb8360e0dafb90ac1e0c9b13db041cc65d35f))
* **pipeline:** honor step env for CI and PR commands ([#59](https://github.com/Blakeolson21/no-slop/issues/59)) ([0d5e739](https://github.com/Blakeolson21/no-slop/commit/0d5e73923e3f09ab049796b92792a87ccf5ff38f))
* **pipeline:** ignore deleted files for intent matching ([#212](https://github.com/Blakeolson21/no-slop/issues/212)) ([ca17d1e](https://github.com/Blakeolson21/no-slop/commit/ca17d1ed2db2c58c066fb0c018ebcc9b7b253f2c))
* **pipeline:** include step error output in diagnostics ([#233](https://github.com/Blakeolson21/no-slop/issues/233)) ([bc8bd5a](https://github.com/Blakeolson21/no-slop/commit/bc8bd5ac62cc5934bbf1ef276c20b0b1725dc38f))
* **pipeline:** independently review automatic fixes ([#634](https://github.com/Blakeolson21/no-slop/issues/634)) ([f2538db](https://github.com/Blakeolson21/no-slop/commit/f2538db8c81127cffbd0da58574ee6275aa5a11a))
* **pipeline:** keep inline code prose in PR summaries ([#220](https://github.com/Blakeolson21/no-slop/issues/220)) ([94a7361](https://github.com/Blakeolson21/no-slop/commit/94a736185220f774fa2ea49921d54b11b3c0a89c))
* **pipeline:** keep local Test validation targeted ([#540](https://github.com/Blakeolson21/no-slop/issues/540)) ([d4d3e58](https://github.com/Blakeolson21/no-slop/commit/d4d3e58cc3a1eb0c5734f57f43b6dd4537d3f6c4))
* **pipeline:** keep monitoring open PRs after CI passes ([#240](https://github.com/Blakeolson21/no-slop/issues/240)) ([41a03e2](https://github.com/Blakeolson21/no-slop/commit/41a03e2a635c8a10d3d4b1de546fad4670464501))
* **pipeline:** let document step fix documentation gaps directly ([#226](https://github.com/Blakeolson21/no-slop/issues/226)) ([82974e9](https://github.com/Blakeolson21/no-slop/commit/82974e9dd84fdb48a2864eaa994c12f176ce7382))
* **pipeline:** make CI auto-fix retry after reruns reliably ([#145](https://github.com/Blakeolson21/no-slop/issues/145)) ([e7320c7](https://github.com/Blakeolson21/no-slop/commit/e7320c70135df494daeb0fe61a41001de46f3e92))
* **pipeline:** narrate PR auto-fix summaries ([#223](https://github.com/Blakeolson21/no-slop/issues/223)) ([902c0c5](https://github.com/Blakeolson21/no-slop/commit/902c0c581cfbd01cc4f244f751c676a2bb64cf7e))
* **pipeline:** preserve local test evidence in PR summaries ([#214](https://github.com/Blakeolson21/no-slop/issues/214)) ([09147b2](https://github.com/Blakeolson21/no-slop/commit/09147b23f53f7a07cb910e5e50dede0aec8dbc3c))
* **pipeline:** prevent clobbered HEAD from shipping unreviewed fixes ([#462](https://github.com/Blakeolson21/no-slop/issues/462)) ([a7e71ea](https://github.com/Blakeolson21/no-slop/commit/a7e71ea92f83ea4a597580dd4c30099d084f79de))
* **pipeline:** recognize green CI after successful rerun ([#647](https://github.com/Blakeolson21/no-slop/issues/647)) ([1c1fe5c](https://github.com/Blakeolson21/no-slop/commit/1c1fe5cc4ef2ff28367a3d0a2a3fa1e3f0fb0528))
* **pipeline:** reconcile parked CI gates ([#486](https://github.com/Blakeolson21/no-slop/issues/486)) ([2bbbc14](https://github.com/Blakeolson21/no-slop/commit/2bbbc143bd4520056e97957883a02615657b2a62))
* **pipeline:** rename follow-up fix rounds to auto-fix ([#73](https://github.com/Blakeolson21/no-slop/issues/73)) ([23e92a8](https://github.com/Blakeolson21/no-slop/commit/23e92a826ea635c2614ab497ca729f500323b210))
* **pipeline:** render PR testing summaries as prose ([#208](https://github.com/Blakeolson21/no-slop/issues/208)) ([6e4d7e1](https://github.com/Blakeolson21/no-slop/commit/6e4d7e1c5ead3b75cf2265b490afd06c8c05ef5d))
* **pipeline:** report live fix progress accurately ([#190](https://github.com/Blakeolson21/no-slop/issues/190)) ([e85c2b6](https://github.com/Blakeolson21/no-slop/commit/e85c2b6b25a83e2aa38bac56aea461ae854aec36))
* **pipeline:** restore deterministic PR body sections ([#663](https://github.com/Blakeolson21/no-slop/issues/663)) ([eda3d33](https://github.com/Blakeolson21/no-slop/commit/eda3d335edd92922d30abf056a6a1b02315c5599))
* **pipeline:** restore findings compatibility and harden review intent ([#51](https://github.com/Blakeolson21/no-slop/issues/51)) ([1b93f60](https://github.com/Blakeolson21/no-slop/commit/1b93f6016577f66982f82c03923685e71bb629d1))
* **pipeline:** scope PR summaries to the final diff ([#605](https://github.com/Blakeolson21/no-slop/issues/605)) ([c70992a](https://github.com/Blakeolson21/no-slop/commit/c70992ad5896cd211e08bfc81ffa43ecce3fd885))
* **pipeline:** stop polling terminal cancelled CI checks ([#637](https://github.com/Blakeolson21/no-slop/issues/637)) ([eb826b4](https://github.com/Blakeolson21/no-slop/commit/eb826b4c5ff5d06b619f3344ecf014c7e7d31001))
* **pipeline:** stop the document step rewriting committed content to match intent ([c439ce9](https://github.com/Blakeolson21/no-slop/commit/c439ce9544dcafa049cb19bfa2ed8c631cd30855))
* **pipeline:** strip chat status footers from fix commit subjects ([0ab6499](https://github.com/Blakeolson21/no-slop/commit/0ab6499ccba43d8fabffce9fee949f85d9aa6032))
* **pipeline:** tighten PR title scope selection ([#87](https://github.com/Blakeolson21/no-slop/issues/87)) ([08bb185](https://github.com/Blakeolson21/no-slop/commit/08bb1857b6d1843e4625452c390cc70a6dc7bbd4))
* **pipeline:** use standard git credential env for steps ([#499](https://github.com/Blakeolson21/no-slop/issues/499)) ([a87d451](https://github.com/Blakeolson21/no-slop/commit/a87d4516381103722863ebbd29e3fc0aed61e591))
* **pipeline:** use workdir for intent git state ([#183](https://github.com/Blakeolson21/no-slop/issues/183)) ([8b9238f](https://github.com/Blakeolson21/no-slop/commit/8b9238f05212e8c5a47a12023b42c3f56a26772c))
* prevent recursive validation runs ([#567](https://github.com/Blakeolson21/no-slop/issues/567)) ([a732435](https://github.com/Blakeolson21/no-slop/commit/a7324354f8fd019ee359b99d82939ae7f433660f))
* **proctree:** verify group leaders before every group kill ([3fca7f3](https://github.com/Blakeolson21/no-slop/commit/3fca7f3850cf926d4fb3092411e1fe14fca5da3c))
* **prompts:** ensure documentation prompts are updated ([#74](https://github.com/Blakeolson21/no-slop/issues/74)) ([37f5e76](https://github.com/Blakeolson21/no-slop/commit/37f5e76510c0776a999847564f842180b8e77c72))
* **prsummary:** link pipeline summary tagline ([#49](https://github.com/Blakeolson21/no-slop/issues/49)) ([d8c80db](https://github.com/Blakeolson21/no-slop/commit/d8c80dbeb9598bfa9a53d9a7e6ad6132e5d12756))
* **rebase:** harden force-push handling ([#54](https://github.com/Blakeolson21/no-slop/issues/54)) ([7f18853](https://github.com/Blakeolson21/no-slop/commit/7f18853913aa0336413327e0163593e46c71abd4))
* **release:** run publish jobs after skipped validation ([#113](https://github.com/Blakeolson21/no-slop/issues/113)) ([2fa5d24](https://github.com/Blakeolson21/no-slop/commit/2fa5d24850aa4bd1fd3b24693554257b32a9d2e5))
* remove doc guard ([#52](https://github.com/Blakeolson21/no-slop/issues/52)) ([bdb902f](https://github.com/Blakeolson21/no-slop/commit/bdb902f0a4a1e453157c936ecfa65355e3d938e7))
* **review:** add note to avoid running tests during review ([#81](https://github.com/Blakeolson21/no-slop/issues/81)) ([594db31](https://github.com/Blakeolson21/no-slop/commit/594db3189c45c6882a3a13fedc1de2ce7a6589a0))
* **review:** remove commit subjects from the review prompt ([#56](https://github.com/Blakeolson21/no-slop/issues/56)) ([f6d729e](https://github.com/Blakeolson21/no-slop/commit/f6d729ed8038d88c156e0e024a155cd6dc907b7c))
* **scm/azuredevops:** pass PR description via temp file ([#501](https://github.com/Blakeolson21/no-slop/issues/501)) ([#510](https://github.com/Blakeolson21/no-slop/issues/510)) ([2d10688](https://github.com/Blakeolson21/no-slop/commit/2d10688c1753de85358ce6a74b72d90e696c4f05))
* **scm/github:** target known PR explicitly from bare gate repo ([#522](https://github.com/Blakeolson21/no-slop/issues/522)) ([4ba40ae](https://github.com/Blakeolson21/no-slop/commit/4ba40aee93e80f7e9ee82f510c12eb5d9e26f3ea))
* **scm:** make GitHub operations repo-aware ([#256](https://github.com/Blakeolson21/no-slop/issues/256)) ([5964ad9](https://github.com/Blakeolson21/no-slop/commit/5964ad9d521860f314fb1c992b8fa7870db59fc3))
* **scm:** resolve SSH host aliases for provider routing ([#520](https://github.com/Blakeolson21/no-slop/issues/520)) ([18456e4](https://github.com/Blakeolson21/no-slop/commit/18456e4ef6b59a649ed6c537ec670b397225b92c))
* **security:** load repo config from default branch, not pushed SHA (supply-chain RCE) ([#297](https://github.com/Blakeolson21/no-slop/issues/297)) ([21ff425](https://github.com/Blakeolson21/no-slop/commit/21ff425c7e8c2dd3dda6149cbd47d32b8c7b5da7))
* **shellenv:** reap process trees, not just process groups ([7c8a1de](https://github.com/Blakeolson21/no-slop/commit/7c8a1dea679d1484f5dfbf72273f346dc776e228))
* **shellenv:** retry degraded daemon environment fallback ([#216](https://github.com/Blakeolson21/no-slop/issues/216)) ([14cd1dd](https://github.com/Blakeolson21/no-slop/commit/14cd1dd3f0d64d9cbdb3d86c6f5318b650549ff6))
* **shellenv:** signal every sample round; correct poller-join rationale ([07a233c](https://github.com/Blakeolson21/no-slop/commit/07a233c2461401a2889890a6f71d36d443bcf152))
* **skill:** escalate ask-user findings to users ([#248](https://github.com/Blakeolson21/no-slop/issues/248)) ([c015392](https://github.com/Blakeolson21/no-slop/commit/c015392d7d0e4c59ca6f887c9547186105684da3))
* **skill:** improve intent guidance completeness ([#250](https://github.com/Blakeolson21/no-slop/issues/250)) ([4cebf97](https://github.com/Blakeolson21/no-slop/commit/4cebf97fdb570d023b2b536ad8c8832e1e557575))
* **skill:** install skills through symlinked bases ([#251](https://github.com/Blakeolson21/no-slop/issues/251)) ([3d285e7](https://github.com/Blakeolson21/no-slop/commit/3d285e792dbe8a9d639f8600766a897ecb3ad541))
* **skill:** mark installed skills internal ([#279](https://github.com/Blakeolson21/no-slop/issues/279)) ([d7878f7](https://github.com/Blakeolson21/no-slop/commit/d7878f7184d476cb3ac2cfbbb06e7abb019694a3))
* stop AXI polling and bound daemon logs ([#565](https://github.com/Blakeolson21/no-slop/issues/565)) ([83750b9](https://github.com/Blakeolson21/no-slop/commit/83750b9c52fff8abae8d2f96d8e296186bad6eec))
* **telemetry:** reduce event data volume ([#155](https://github.com/Blakeolson21/no-slop/issues/155)) ([0b8c6a0](https://github.com/Blakeolson21/no-slop/commit/0b8c6a036ed09244ce04cad870c3cdaf296d022f))
* **telemetry:** use self-hosted Umami defaults ([#157](https://github.com/Blakeolson21/no-slop/issues/157)) ([efef934](https://github.com/Blakeolson21/no-slop/commit/efef934ba9ec451ac3389f2f069caa9e6bf43287))
* **tui:** backfill rerun pipeline steps without stale placeholders ([#111](https://github.com/Blakeolson21/no-slop/issues/111)) ([ae4ae8b](https://github.com/Blakeolson21/no-slop/commit/ae4ae8b91cbc7c830a7ce05b5728887d56f6dc67))
* **tui:** keep fix review row within width ([#224](https://github.com/Blakeolson21/no-slop/issues/224)) ([abb1d9a](https://github.com/Blakeolson21/no-slop/commit/abb1d9a285f998e3c4761d832688b112795ddbbc))
* **tui:** preserve accumulated timer when step auto-fixes ([#61](https://github.com/Blakeolson21/no-slop/issues/61)) ([b709608](https://github.com/Blakeolson21/no-slop/commit/b709608097795fc19d9d737d701a1f7ab5f8e9d6))
* **tui:** show completed fix progress counts ([#194](https://github.com/Blakeolson21/no-slop/issues/194)) ([fdc4dea](https://github.com/Blakeolson21/no-slop/commit/fdc4dea9b2944460f54be6447570d580b868c325))
* **tui:** show findings navigation hint for multiple findings ([#62](https://github.com/Blakeolson21/no-slop/issues/62)) ([8c65d6b](https://github.com/Blakeolson21/no-slop/commit/8c65d6b928653550e2f06f38f8a62c312031072b))
* **tui:** use available height for stacked log tail ([#68](https://github.com/Blakeolson21/no-slop/issues/68)) ([4a5a99a](https://github.com/Blakeolson21/no-slop/commit/4a5a99ab9484eba0091c17294891138e8d89ff6a))
* **update:** authenticate GitHub release requests ([#636](https://github.com/Blakeolson21/no-slop/issues/636)) ([c0920cd](https://github.com/Blakeolson21/no-slop/commit/c0920cd1675d562ee7d5e97a6b45d0cba82edde6))
* **update:** confirm daemon takeover before replacing running daemon ([#200](https://github.com/Blakeolson21/no-slop/issues/200)) ([5fd0cf2](https://github.com/Blakeolson21/no-slop/commit/5fd0cf254e9f9dc31b5d478514c03cdf313e833c))
* **update:** disable self-update so it cannot overwrite the fork's patches ([3737516](https://github.com/Blakeolson21/no-slop/commit/373751660b2f2bea9d9d3d4dfdf283ae5d087154))
* **update:** guard daemon restarts by executable path ([#76](https://github.com/Blakeolson21/no-slop/issues/76)) ([8d2782d](https://github.com/Blakeolson21/no-slop/commit/8d2782ddbef6ff5820b4a5e9ed06b2f0eb2773af))
* **update:** make --version a side-effect-free read-only probe ([#423](https://github.com/Blakeolson21/no-slop/issues/423)) ([65e37bc](https://github.com/Blakeolson21/no-slop/commit/65e37bcce93507fea3680abd28bcb9f0ace1b077))
* updater self-update and install.sh for user-owned paths on macOS ([#66](https://github.com/Blakeolson21/no-slop/issues/66)) ([119665e](https://github.com/Blakeolson21/no-slop/commit/119665e8843ffb0360feea9ef74f59f803a5a34c))
* **update:** reset daemon after self-update and document failure handling ([#70](https://github.com/Blakeolson21/no-slop/issues/70)) ([c1001d8](https://github.com/Blakeolson21/no-slop/commit/c1001d8da5e12e5c51069b84752b4cf298617fde))
* **update:** resolve beta releases from tags ([#152](https://github.com/Blakeolson21/no-slop/issues/152)) ([e2558ba](https://github.com/Blakeolson21/no-slop/commit/e2558baeb9761160a6966844689808587b7fbeeb))
* **update:** warn before updating with active runs ([#238](https://github.com/Blakeolson21/no-slop/issues/238)) ([15951e1](https://github.com/Blakeolson21/no-slop/commit/15951e122babd12afe6c3dcaf96816eae162cac0))
* **winproc:** suppress console window flashing for child processes on windows ([#418](https://github.com/Blakeolson21/no-slop/issues/418)) ([7625211](https://github.com/Blakeolson21/no-slop/commit/7625211125c399c9665ff7e7edc1dd8aa17af075))
* **wizard:** render branch step input and status inline ([#108](https://github.com/Blakeolson21/no-slop/issues/108)) ([d945e2d](https://github.com/Blakeolson21/no-slop/commit/d945e2dbd6130504a9f3e4861ca8f37ef1c0eda2))
* **wizard:** wait for daemon run before attach handoff ([#119](https://github.com/Blakeolson21/no-slop/issues/119)) ([ca47098](https://github.com/Blakeolson21/no-slop/commit/ca47098b34040a18765d95922eb3158052792f28))
