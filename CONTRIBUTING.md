...
If you revise the PR description after no-slop creates it, preserve the generated `## Pipeline` section. Replacing the whole body removes the signature and makes the required check fail until no-slop writes the section again.
