...
func readOnlyMethod(method string) bool {
	switch method {
	case MethodHealth, MethodGetResponseReceipt, MethodGetRun, MethodGetStepDiff, MethodGetRuns, MethodGetRunsForHead, MethodGetActiveRun, MethodGateContext, MethodAdmitPush:
		return true
	default:
		return false
	}
