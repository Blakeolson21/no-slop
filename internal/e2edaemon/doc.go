...
// slot cap.
//
// Scope includes temporary E2E daemons (NS_TEST_START_DAEMON detached starts
// under harness temp roots) and eval candidate roots. The shared production
// daemon and external sleep-loop keepalive shells are out of scope.
//
