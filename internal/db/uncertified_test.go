...
func TestUncertifiedPipelineRangeUpsertGetDelete(t *testing.T) {
	...
	if got == nil || got.FromSHA != "from-a" || got.ToSHA != "to-a" || got.SourceRunID != run.ID || got.RecoveryState != ReviewRecoverySelectionApplied || !got.SelectionApplied {
	...
	if got == nil || got.FromSHA != "from-b" || got.ToSHA != "to-b" || got.SourceRunID != run2.ID || got.RecoveryState != ReviewRecoverySelectionApplied || !got.SelectionApplied {
