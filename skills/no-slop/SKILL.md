---
name: no-slop
description: Validate your code changes through the no-slop pipeline - automated code review, tests, lint, docs, push, PR, and CI - before they reach the configured push target. Use when the user asks to run no-slop, gate or ship or validate their changes, push safely, asks you to do a task and then validate it, or invokes /no-slop.
user-invocable: true
---
